...
const LAWYERS: LawyerProfile[] = [
  {
    ...
    hint: 'Her work focuses on examining the abusive uses of AI such as for harms to children, or for deceptive purposes in court evidentiary proceedings.',
    initial: 'RP',
  ...
  {
    name: 'Scott Sugarman',
    focus: 'Criminal defense & digital evidence',
    hint: '50+ year criminal defense attorney (Stanford Law \'75) specializing in computer crimes, child exploitation cases, and complex digital evidence in federal court.',
    initial: 'SS',
  ...
  {
    name: 'Mark Boskovich',
    focus: 'Sexual abuse & personal injury',
    hint: 'Plaintiff-side attorney specializing in sexual abuse and personal injury cases, represents victims of digital harm and exploitation.',
    initial: 'MB',
